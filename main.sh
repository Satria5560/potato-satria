...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m               AUTOSCRIPT PREMIUM SN STORE             \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
wget raw.githubusercontent.com/Satria5560/potato-satria/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
